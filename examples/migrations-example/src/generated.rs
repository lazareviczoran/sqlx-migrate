...
#[allow(dead_code)]
#[allow(clippy::all, clippy::pedantic)]
#[path = "/Users/zoran/projects/sqlx-migrate.git/use-sqlx-enum-fix/examples/migrations-example/migrations/20211215162220_plush_sharks.migrate.rs"]
...
#[allow(dead_code)]
#[allow(clippy::all, clippy::pedantic)]
#[path = "/Users/zoran/projects/sqlx-migrate.git/use-sqlx-enum-fix/examples/migrations-example/migrations/20211215162220_plush_sharks.revert.rs"]
/// Created at 20211215162220.
        ...
        sqlx_migrate::Migration::new(
                ...
                |ctx| std::boxed::Box::pin(async move {
                    ...
                    ctx.tx()
                        .execute(
                            include_str!(
                                "/Users/zoran/projects/sqlx-migrate.git/use-sqlx-enum-fix/examples/migrations-example/migrations/20211215161742_initial_migration.migrate.sql"
                            ),
                        )
                        .await?;
                    Ok(())
            ...
            .reversible(|ctx| std::boxed::Box::pin(async move {
                ...
                ctx.tx()
                    .execute(
                        include_str!(
                            "/Users/zoran/projects/sqlx-migrate.git/use-sqlx-enum-fix/examples/migrations-example/migrations/20211215161742_initial_migration.revert.sql"
                        ),
                    )
                    .await?;
                Ok(())
